...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab2150>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lsprof', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab2150>, origin='/usr/lib/python3.11/lib-dynload/_lsprof.cpython-311-x86_64-linux-gnu.so')"
