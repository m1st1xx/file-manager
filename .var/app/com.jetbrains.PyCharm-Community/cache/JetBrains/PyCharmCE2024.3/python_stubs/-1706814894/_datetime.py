# encoding: utf-8
# module _datetime
# from /usr/lib/python3.11/lib-dynload/_datetime.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
...
datetime_CAPI = None # (!) real value is '<capsule object "datetime.datetime_CAPI" at 0x7f25faa63810>'

UTC = None # (!) real value is 'datetime.timezone.utc'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1510>'

__spec__ = None # (!) real value is "ModuleSpec(name='_datetime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1510>, origin='/usr/lib/python3.11/lib-dynload/_datetime.cpython-311-x86_64-linux-gnu.so')"
