# encoding: utf-8
# module cryptography.hazmat.bindings._openssl.lib
# from /app/lib/python3.11/site-packages/cryptography/hazmat/bindings/_openssl.abi3.so
# by generator 1.147
# no doc
...
Cryptography_HAS_300_EVP_CIPHER = 1

Cryptography_HAS_300_FIPS = 1
...
Cryptography_HAS_EVP_PKEY_set_alias_type = 0

Cryptography_HAS_FIPS = 0

Cryptography_HAS_GET_EXTMS_SUPPORT = 1

Cryptography_HAS_IMPLICIT_RSA_REJECTION = 0
...
Cryptography_HAS_PKCS12_SET_MAC = 1

Cryptography_HAS_PKCS7_FUNCS = 1

Cryptography_HAS_POLY1305 = 1
Cryptography_HAS_PROVIDERS = 1
...
Cryptography_HAS_SSL_OP_IGNORE_UNEXPECTED_EOF = 1
...
Cryptography_HAS_UNEXPECTED_EOF_WHILE_READING = 1

Cryptography_HAS_VERIFIED_CHAIN = 1

CRYPTOGRAPHY_HAS_WORKING_ED25519 = 1
...
CRYPTOGRAPHY_OPENSSL_300_OR_GREATER = 1
...
SSL_OP_IGNORE_UNEXPECTED_EOF = 128
...
def ASN1_ENUMERATED_free(ASN1_ENUMERATED, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    ...
    CFFI C function from cryptography.hazmat.bindings._openssl.lib
    """
    pass
...
def d2i_DHxparams_bio(BIO, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def EVP_PKEY_set_alias_type(EVP_PKEY, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def i2d_DHxparams_bio(BIO, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def PKCS12_set_mac(PKCS12, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    int PKCS12_set_mac(PKCS12 *, char *, int, unsigned char *, int, int, EVP_MD *);
...
def SSL_CTX_set_msg_callback(SSL_CTX, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    void SSL_CTX_set_msg_callback(SSL_CTX *, void(*)(int, int, int, void *, size_t, SSL *, void *));
    
    CFFI C function from cryptography.hazmat.bindings._openssl.lib
    """
    pass

def SSL_CTX_set_msg_callback_arg(SSL_CTX, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def SSL_get_extms_support(SSL, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
