...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8790>'

__spec__ = None # (!) real value is "ModuleSpec(name='_xxsubinterpreters', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8790>, origin='/usr/lib/python3.11/lib-dynload/_xxsubinterpreters.cpython-311-x86_64-linux-gnu.so')"
