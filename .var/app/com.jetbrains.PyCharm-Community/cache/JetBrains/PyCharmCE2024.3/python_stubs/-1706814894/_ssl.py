...
OPENSSL_VERSION = 'OpenSSL 3.1.8 11 Feb 2025'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8190>'

__spec__ = None # (!) real value is "ModuleSpec(name='_ssl', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8190>, origin='/usr/lib/python3.11/lib-dynload/_ssl.cpython-311-x86_64-linux-gnu.so')"
