...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25fb31a090>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25fb31a090>, origin='/usr/lib/python3.11/lib-dynload/_lzma.cpython-311-x86_64-linux-gnu.so')"
