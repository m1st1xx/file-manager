...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab2f10>'

__spec__ = None # (!) real value is "ModuleSpec(name='_asyncio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab2f10>, origin='/usr/lib/python3.11/lib-dynload/_asyncio.cpython-311-x86_64-linux-gnu.so')"
