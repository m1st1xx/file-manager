...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab9010>'

__spec__ = None # (!) real value is "ModuleSpec(name='mmap', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab9010>, origin='/usr/lib/python3.11/lib-dynload/mmap.cpython-311-x86_64-linux-gnu.so')"
