...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1990>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses_panel', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1990>, origin='/usr/lib/python3.11/lib-dynload/_curses_panel.cpython-311-x86_64-linux-gnu.so')"
