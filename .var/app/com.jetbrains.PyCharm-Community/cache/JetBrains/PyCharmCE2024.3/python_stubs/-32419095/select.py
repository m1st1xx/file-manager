# encoding: utf-8
# module select
# from /usr/lib/python3.11/lib-dynload/select.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25fb2f0a10>'

__spec__ = None # (!) real value is "ModuleSpec(name='select', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25fb2f0a10>, origin='/usr/lib/python3.11/lib-dynload/select.cpython-311-x86_64-linux-gnu.so')"
