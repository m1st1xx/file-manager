...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8710>'

__spec__ = None # (!) real value is "ModuleSpec(name='audioop', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab8710>, origin='/usr/lib/python3.11/lib-dynload/audioop.cpython-311-x86_64-linux-gnu.so')"
