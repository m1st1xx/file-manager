# encoding: utf-8
# module _elementtree
# from /usr/lib/python3.11/lib-dynload/_elementtree.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1010>'

__spec__ = None # (!) real value is "ModuleSpec(name='_elementtree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab1010>, origin='/usr/lib/python3.11/lib-dynload/_elementtree.cpython-311-x86_64-linux-gnu.so')"
