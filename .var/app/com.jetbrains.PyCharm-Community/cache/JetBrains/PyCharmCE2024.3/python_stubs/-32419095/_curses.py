...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7f25faa62fd0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab24d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25faab24d0>, origin='/usr/lib/python3.11/lib-dynload/_curses.cpython-311-x86_64-linux-gnu.so')"
